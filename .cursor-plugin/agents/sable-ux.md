...
<required-actions>
Follow shared actions in `.cursor/references/agent-preamble.md`.
</required-actions>
...
0. **Design system check.** Follow the detection and loading rules in
   `.cursor/references/design-system-loading.md`. Read `tokens.md`
...
- Design system loading rules are in `.cursor/references/design-system-loading.md`.
</constraints>
